...
- **未实现**: 完整 TUI/CLI timeout 事件接入, procedural adoption, real emergence quality dogfood, complex implicit preference evolution hardening, backend abstraction
