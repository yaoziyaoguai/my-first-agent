...
5. `docs/RELEASE_TAG_AUTHORIZATION_PACKET.md`
6. `docs/MCP_EXTERNAL_INTEGRATION_READINESS.md`
7. `docs/MCP_REAL_INTEGRATION_SLICE_DESIGN.md`
8. `docs/RUNTIME_TRACE_TOOLRESULT_MIGRATION.md`
9. `docs/RUNTIME_TRACE_TOOLRESULT_SLICE_DESIGN.md`
10. `docs/FINAL_ROADMAP_COMPLETION_EVIDENCE.md`
11. `docs/SAFE_LOCAL_RELEASE_READINESS.md`
12. `AGENTS.md`
