...
| 文档 | 日期 | 说明 |
|------|------|------|
| [v1-synthetic-user-dogfood-report.md](v1-synthetic-user-dogfood-report.md) | 2026-06-04 | **最新** v1 Synthetic User Dogfood：17/17 journeys 执行 (11 fake/local + 6 real)。F-001 P0 HOTFIX_DECISION_REQUIRED，F-002 P3 MODEL_BEHAVIOR，F-003/F-004 P2 FUTURE_DEBT |
