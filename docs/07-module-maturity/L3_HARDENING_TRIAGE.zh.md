...
| **Memory** | L2 | L3 | canonical MemoryOwner; noop/update; consolidation unfreeze | OWNER_DECISION | ✗ | BLOCKED_RECORD_DEBT | OD-9 owner 审批 | 不解冻 consolidation/emergence | MemoryOwner realized + single-owner golden | High |
...
| **Skill** | L2 | L3 | production core-loop golden (current golden is local sample fixture) | NONE | ✓ | HARDEN_NEXT | Core-loop golden E2E via fakeprovider | 不升 production-ready; 不把实验行为当目标 | Core-loop golden green | Medium |
